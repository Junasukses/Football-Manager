                                    ...
                                    <div class="card-body">
                                        <form action="" method="post">
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="username" name="username" type="text" placeholder="Masukkan Username Anda" />
                                            ...
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="telepon" name="telepon" type="number" placeholder="Masukkan Teleon Anda" />
